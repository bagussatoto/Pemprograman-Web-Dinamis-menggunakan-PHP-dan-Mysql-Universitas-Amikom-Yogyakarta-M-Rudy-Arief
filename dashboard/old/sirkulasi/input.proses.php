...
if ($module=='sirkulasi' AND $act=='insert'){
	...
	elseif(!$ang OR !$buku){
     ...
     $ins=mysql_query("INSERT INTO sirkulasi(tanggalPinjam,tanggalHarusKembali,tanggalKembali,IDAnggota,isbn,denda)
                            VALUES('$PtanggalPinjam','$PtanggalHarusKembali','$PtanggalKembali','$PIDAnggota',
                            '$Pisbn','$Pdenda' )");
